...
//       bg-gray-800 text-white p-2 rounded-full cursor-pointer 
...
//   const handleMouseDown = (e) => setStart(e.clientX);

//   const handleClick = (e) => {
//     const drag = Math.abs(e.clientX - Start);
//     if (drag > 5) {
//       e.preventDefault(); 
//     }
//   };
...
//                     bg-[#eff3f8] text-gray-900 relative 
//                   "
//                 >
//                   <div className="w-12 h-12 flex items-center justify-center mb-3 transition-colors duration-300">
//                     {category.icon}
//                   </div>
